...
@NamedQuery(
        name = Meal.FIND_BY_GROUP,
        query = "select m from Meal m  where m.user.group.name = :groupname order by m.date desc, m.time desc"
)
})
...
public class Meal extends AbstractEntity {
    ...
    public static final String FIND_BY_GROUP = "meals.findByGroup";
