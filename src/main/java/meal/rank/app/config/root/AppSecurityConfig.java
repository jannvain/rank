...
import meal.rank.app.security.AjaxAuthenticationSuccessHandler;
import meal.rank.app.security.SecurityUserDetailsService;
...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
        	.csrf().disable()
            .authorizeRequests()
            .antMatchers("/mealimages/xs/**").permitAll()
            .antMatchers("/mealimages/lg/**").permitAll()
            .antMatchers("/resources/public/**").permitAll()
            .antMatchers("/resources/img/**").permitAll()
            .antMatchers("/resources/pic/xs/**").permitAll()
            .antMatchers("/resources/css/**").permitAll()

            .antMatchers("/resources/pic/lg/**").permitAll()
            .antMatchers("/resources/bower_components/**").permitAll()
//            .antMatchers(HttpMethod.POST, "/user").permitAll()
//            .antMatchers(HttpMethod.GET, "/user").permitAll()
//            .antMatchers(HttpMethod.POST, "/meal").permitAll()
//            .antMatchers(HttpMethod.GET, "/meal").permitAll()
            .antMatchers(HttpMethod.POST, "/api/user").permitAll()
            .antMatchers(HttpMethod.GET, "/api/user").permitAll()
            .antMatchers(HttpMethod.POST, "/api/newmeal").permitAll()
            .antMatchers(HttpMethod.POST, "/api/uploadmeal").permitAll()

            .antMatchers(HttpMethod.GET, "/api/meal").permitAll()
            .antMatchers(HttpMethod.GET, "/api/mymeals").permitAll()

            .anyRequest().authenticated()
            .and()
            .formLogin()
            .defaultSuccessUrl("/resources/meal-rank-app.html")
