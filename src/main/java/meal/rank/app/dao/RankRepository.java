...
public class RankRepository {
    ...
    public List<Rank> findRankByGroupName(String groupname) {
        List<Rank> ranks = em.createNamedQuery(Rank.FIND_BY_GROUP, Rank.class)
    ...
    public List<Object[]> findRankByGroupNameStat(String groupname, String username) {
        List<Object[]> ranks = em.createNamedQuery(Rank.FIND_BY_GROUP_STAT, Object[].class)
                .setParameter("groupname", groupname)
                .setParameter("username", username)
