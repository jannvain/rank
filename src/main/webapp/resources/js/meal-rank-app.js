...
var app = angular.module('mealRankApp', ['ngRoute',  'ngFileUpload', 'ngAnimate', 'mealList', 
                               'angular-datepicker', 'frontendServices', 'spring-security-csrf-token-interceptor', 'ngDropdowns'])
...
.config(function($routeProvider, $httpProvider) {
	...
	$routeProvider.when('/', {
		templateUrl : '/resources/meal-list.html',
		controller : 'MealListCtrl',
		notInroot: false,
		viewTitle: 'RankMyFood',
	}).when('/meal/:mealId', {
		templateUrl : '/resources/meal-details.html',
		controller : 'MealDetailCtrl',
		viewTitle: '...',
		notInRoot: true
	}).when('/newmeal', {
		templateUrl : '/resources/meal-new.html',
		controller : 'MealNewCtrl',
		viewTitle: '...',
		notInRoot: true
	}).when('/compare', {
		templateUrl : '/resources/compare.html',
		controller : 'MealCompareCtrl',
		viewTitle: '...',
		notInRoot: true
	})
	.when('/settings', {
		templateUrl : '/resources/settings.html',
		controller : 'SettingsCtrl',
		viewTitle: '...',
		notInRoot: true
	}).when('/mysummary', {
		templateUrl : '/resources/mysummary.html',
...
.directive("dropdown", function($rootScope) {
	return {
		restrict: "E",
		templateUrl: "public/partials/dropdown.html",
		scope: {
			placeholder: "@",
			list: "=",
			selected: "=",
