...
import meal.rank.app.dao.MealRepository;
...
/*
    ...
    public void testSearchMealsByDate() throws Exception {
        mockMvc.perform(get("/meal")
                .param("fromDate", "2015/01/04")
                .param("toDate", "2015/01/04")
                .param("pageNumber", "1")
                ...
                .andExpect(jsonPath("$.['meals'].[1].['description']").value("Porridge"));
    }
*/
...
/*    
    ...
    public void testSaveMeals() throws Exception {
        mockMvc.perform(post("/api/meal")
                ...
                .content("[{\"id\":\"1\", \"date\": \"2015/01/01\",\"time\": \"13:00\", \"description\": \"test\" }]")
                .accept(MediaType.APPLICATION_JSON)
...
*/
    ...
    public void deleteMeals() throws Exception {
        mockMvc.perform(delete("/api/meal")
                .contentType(MediaType.APPLICATION_JSON)
                .content("[3]")
                .accept(MediaType.APPLICATION_JSON)
                .principal(new PrincipalImpl(UserServiceTest.USERNAME)))
        ...
        Meal meal = mealRepository.findMealById(3L);
